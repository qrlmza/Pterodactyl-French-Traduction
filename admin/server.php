...
return [
    'exceptions' => [
        ...
        'daemon_exception' => 'Il y avait une exception lors de la tentative de communication avec le daemon résultant une erreur HTTP/:code comme réponse. Cette exception a été enregistrée.',
    ...
    'alerts' => [
        ...
        'server_created' => 'Le serveur a été créé avec succès sur le panneau. Veuillez autoriser le daemon quelques minutes pour installer complètement ce serveur.',
        ...
        'node_required' => 'Vous devez avoir configuré au moins une node avant de pouvoir ajouter un serveur à ce panel.',
        'transfer_nodes_required' => 'Vous devez avoir au moins deux nodes configurées avant de pouvoir transférer des serveurs.',
        'transfer_started' => 'Le transfert de serveur a été lancé.',
        'transfer_not_viable' => 'La node que vous avez sélectionné ne dispose pas de l\'espace disque requis ou de la mémoire disponible pour accueillir ce serveur.',
    ],
];
